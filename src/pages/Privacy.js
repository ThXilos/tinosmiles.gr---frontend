        ...
        <div className="--column">
          <div className="--section">
            ...
            <p className="--subtitle">
              ...
              email address, phone number, and any other information you choose
              to provide.
            </p>
          </div>
          <div className="--section">
            ...
            <p className="--subtitle">
              ...
              contacting you in response to your inquiry or message. We do not
              use this information for any other purpose, nor do we share or
          ...
          <div className="--section">
            ...
            <p className="--subtitle">
              ...
              we hold about you. You also have the right to request that we
